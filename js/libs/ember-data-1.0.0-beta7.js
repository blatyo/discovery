 ...
 */ (function(global) {
    ...
    define("activemodel-adapter/lib/initializers", ["../../ember-data/lib/system/container_proxy", "./system/active_model_serializer", "./system/active_model_adapter"],
    ...
    define("activemodel-adapter/lib/main", ["./system", "./initializers", "exports"],
    ...
    define("activemodel-adapter/lib/system", ["./system/embedded_records_mixin", "./system/active_model_adapter", "./system/active_model_serializer", "exports"],
    ...
    define("activemodel-adapter/lib/system/active_model_adapter", ["../../../ember-data/lib/adapters", "../../../ember-data/lib/system/adapter", "../../../ember-inflector/lib/main", "./active_model_serializer", "./embedded_records_mixin", "exports"],
    ...
    **/
    ...
    define("activemodel-adapter/lib/system/active_model_serializer", ["../../../ember-inflector/lib/main", "../../../ember-data/lib/serializers/rest_serializer", "exports"],
    ...
    */
    ...
    define("activemodel-adapter/lib/system/embedded_records_mixin", ["../../../ember-inflector/lib/main", "exports"],
    ...
    */
    ...
    define("ember-data/lib/adapters", ["./adapters/fixture_adapter", "./adapters/rest_adapter", "exports"],
    ...
    */
    ...
    define("ember-data/lib/adapters/fixture_adapter", ["../system/adapter", "exports"],
    ...
    */
    ...
    define("ember-data/lib/adapters/rest_adapter", ["../system/adapter", "exports"],
    ...
    */
    ...
    define("ember-data/lib/core", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/initializers", ["./system/store", "./serializers", "./adapters", "./system/debug/debug_adapter", "./system/container_proxy", "./transforms"],
    ...
    */
    ...
    define("ember-data/lib/serializers", ["./serializers/json_serializer", "./serializers/rest_serializer", "exports"],
    ...
    define("ember-data/lib/serializers/json_serializer", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/serializers/rest_serializer", ["./json_serializer", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/adapter", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/system/changes", ["./changes/attribute_change", "./changes/relationship_change", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/changes/attribute_change", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/system/changes/relationship_change", ["../model", "exports"],
    ...
    */
        ...
        RelationshipChange.createChange = function(firstRecord, secondRecord, store, options) {
            ...
            var firstRecordType = firstRecord.constructor,
                changeType;
    ...
    */
        RelationshipChange.prototype = {
            ...
            getSecondRecordName: function() {
                var name = this.secondRecordName,
                    parent;
    ...
    define("ember-data/lib/system/container_proxy", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/system/debug", ["./debug/debug_info", "./debug/debug_adapter", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/debug/debug_adapter", ["../model", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/debug/debug_info", ["../model", "exports"],
    ...
    define("ember-data/lib/system/model", ["./model/model", "./model/attributes", "./model/states", "./model/errors", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/model/attributes", ["./model", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/model/errors", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/system/model/model", ["./states", "./errors", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/model/states", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/system/record_array_manager", ["./record_arrays", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/record_arrays", ["./record_arrays/record_array", "./record_arrays/filtered_record_array", "./record_arrays/adapter_populated_record_array", "./record_arrays/many_array", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/record_arrays/adapter_populated_record_array", ["./record_array", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/record_arrays/filtered_record_array", ["./record_array", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/record_arrays/many_array", ["./record_array", "../changes", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/record_arrays/record_array", ["../store", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/relationships", ["./relationships/belongs_to", "./relationships/has_many", "../system/relationships/ext", "exports"],
    ...
    */
    ...
    define("ember-data/lib/system/relationships/belongs_to", ["../model", "exports"],
    ...
    */
      ...
      */
            belongsToWillChange: Ember.beforeObserver(function(record, key) {
                if (get(record, 'isLoaded')) {
                    ...
                    if (oldParent) {
                        var store = get(record, 'store'),
                            change = DS.RelationshipChange.createChange(record, oldParent, store, {
                                key: key,
                                kind: "belongsTo",
                                changeType: "remove"
                            });
      ...
      */
            belongsToDidChange: Ember.immediateObserver(function(record, key) {
                if (get(record, 'isLoaded')) {
                    ...
                    if (newParent) {
                        var store = get(record, 'store'),
                            change = DS.RelationshipChange.createChange(record, newParent, store, {
                                key: key,
                                kind: "belongsTo",
                                changeType: "add"
                            });
    ...
    define("ember-data/lib/system/relationships/ext", ["../../../../ember-inflector/lib/system", "../model"],
    ...
    */
    ...
    define("ember-data/lib/system/relationships/has_many", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/system/store", ["exports"],
    ...
    */
    ...
    define("ember-data/lib/transforms", ["./transforms/base", "./transforms/number", "./transforms/date", "./transforms/string", "./transforms/boolean", "exports"],
    ...
    define("ember-data/lib/transforms/base", ["exports"],
    ...
    define("ember-data/lib/transforms/boolean", ["./base", "exports"],
    ...
    define("ember-data/lib/transforms/date", ["./base", "exports"],
    ...
    define("ember-data/lib/transforms/number", ["./base", "exports"],
    ...
    define("ember-data/lib/transforms/string", ["./base", "exports"],
    ...
    define("ember-inflector/lib/ext/string", ["../system/string"],
    ...
    define("ember-inflector/lib/main", ["./system", "./ext/string", "exports"],
    ...
    define("ember-inflector/lib/system", ["./system/inflector", "./system/string", "./system/inflections", "exports"],
    ...
    define("ember-inflector/lib/system/inflections", ["exports"],
    ...
    */
    ...
    define("ember-inflector/lib/system/string", ["./inflector", "exports"],
